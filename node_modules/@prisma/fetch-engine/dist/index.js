...
__export(index_exports, {
  ...
  download: () => import_chunk_J2EYJ4KV.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_J2EYJ4KV.getBinaryName,
  getCacheDir: () => import_chunk_YJOPKU47.getCacheDir,
  getProxyAgent: () => import_chunk_LOOX3H4O.getProxyAgent,
  getVersion: () => import_chunk_J2EYJ4KV.getVersion,
  maybeCopyToTmp: () => import_chunk_J2EYJ4KV.maybeCopyToTmp,
  overwriteFile: () => import_chunk_YJOPKU47.overwriteFile,
  plusX: () => import_chunk_J2EYJ4KV.plusX,
  vercelPkgPathRegex: () => import_chunk_J2EYJ4KV.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_J2EYJ4KV = require("./chunk-J2EYJ4KV.js");
