...
var chunk_J2EYJ4KV_exports = {};
__export(chunk_J2EYJ4KV_exports, {
  download: () => download,
...
module.exports = __toCommonJS(chunk_J2EYJ4KV_exports);
...
var require_kill = (0, import_chunk_QGM4M3NI.__commonJS)({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/kill.js"(exports, module2) {
    "use strict";
    var os2 = (0, import_chunk_QGM4M3NI.__require)("os");
...
async function getCachedBinaryPath({
  ...
  const cacheDir = await (0, import_chunk_YJOPKU47.getCacheDir)(channel, version, binaryTarget2);
  if (!cacheDir) {
    return null;
  }
